                                    ...
                                    AuthorizableContract
{
    ...
    {
        return $this->belongsToMany(Machine::class, 'machine_subscribers');
    }
    ...
    public function subscrib(Machine $machine)
    {
        return $machine->subscribers()->where('user_id', $this->id)->count() > 0;
    }

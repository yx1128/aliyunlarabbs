...
Route::patch("/topics/{id}/transforms", "DiscussionsController@transform")->name('discussions.transform');
Route::post("/discussions", "DiscussionsController@store")->name('discussions.store');
Route::get("/discussions/{id}/edit", "DiscussionsController@edit")->name('discussions.edit');
...
Route::get('/users/{id}/mcsubscribers','UsersController@subscribers')->name('users.mcsubscribers');
...
Route::get('/discussions/{id}/{slug?}', "TopicsController@show")->name('discussions.show');
Route::get('{name}', 'PagesController@wildcard')->name('wildcard');
Route::get('{names}', 'PagesController@wildcards')->name('wildcards');
